  ...
  return (
    <section className="bg-background flex flex-col md:flex-row justify-center md:justify-around items-center gap-8 md:gap-12 lg:gap-30 py-10 md:py-4 lg:py-6 px-6 sm:px-10 md:px-12 lg:px-20 mx-auto max-w-7xl">
      ...
      <div className="w-full md:max-w-md lg:max-w-xl flex flex-col gap-4 sm:gap-5 md:gap-6 text-center md:text-left">
        {/* Label */}
        <p className="text-xs sm:text-lg text-blue-600 font-semibold uppercase tracking-widest">
        ...
        {/* Description */}
        <p className="text-gray-400 text-sm sm:text-base md:text-md leading-relaxed line-clamp-2 lg:line-clamp-none">
        ...
        <div className="flex flex-wrap justify-center md:justify-start gap-4 sm:gap-5 md:gap-6 mt-2 sm:mt-3 md:mt-4">
          {/* Stat Item - Members */}
          <div className="bg-card rounded-xl px-4 py-6 sm:px-5 sm:py-7 md:px-6 md:py-8 flex flex-col items-center shadow-md min-w-[90px] sm:min-w-[100px] md:min-w-[110px] flex-1 max-w-[120px] sm:max-w-[130px]">
            <span className="text-accent font-bold text-2xl sm:text-3xl">12k</span>
            <span className="font-semibold mt-1 sm:mt-2 text-xs sm:text-sm md:text-base text-center">
              Members
            </span>
          </div>
          ...
          <div className="bg-card rounded-xl px-4 py-6 sm:px-5 sm:py-7 md:px-6 md:py-8 flex flex-col items-center shadow-md min-w-[90px] sm:min-w-[100px] md:min-w-[110px] flex-1 max-w-[120px] sm:max-w-[130px]">
            <span className="text-accent font-bold text-2xl sm:text-3xl">98+</span>
            <span className="font-semibold mt-1 sm:mt-2 text-xs sm:text-sm md:text-base text-center">
              Discussions
            </span>
          </div>
          ...
          {/* Stat Item - Advisers */}
          <div className="bg-card rounded-xl px-4 py-6 sm:px-5 sm:py-7 md:px-6 md:py-8 flex flex-col items-center shadow-md min-w-[90px] sm:min-w-[100px] md:min-w-[110px] flex-1 max-w-[120px] sm:max-w-[130px]">
            <span className="text-accent font-bold text-2xl sm:text-3xl">10+</span>
            <span className="font-semibold mt-1 sm:mt-2 text-xs sm:text-sm md:text-base text-center">
              Advisers
            </span>
          </div>
