...
const HeroSection: FC = () => {
  ...
  return (
    <section className="h-full lg:h-screen mt-12 lg:mt-0 md:min-w-md lg:min-w-xl bg-card px-4 sm:px-6 md:px-10 lg:px-16 py-6 sm:py-8 md:py-6 grid grid-cols-1 md:grid-cols-2 items-center justify-between gap-2 md:gap-4 lg:gap-8 ">
      {/* Left Content */}
      ...
      <div className="relative sm:mt-4 md:mt-12 lg:mt-0 flex-shrink-0 w-60 sm:w-80 md:w-80 lg:w-fit sm:h-72 md:h-80 lg:h-[480px] flex justify-center items-center mx-auto">
        ...
        <div className="absolute top-1/2 sm:top-2/3 md:top-45 lg:top-80 -left-16 sm:-left-20 md:-left-30 lg:-left-40 bg-blue-500 rounded-lg px-2 sm:px-2 md:px-2 py-1 sm:py-2 flex items-center space-x-2 sm:space-x-3 max-w-xs sm:max-w-5 md:max-w-xs shadow-lg z-20 animate-bounce ">
          ...
          <div className="text-white">
            <p className="font-bold md:text-[10px] lg:text-base ">980k+</p>
            <p className="md:text-[9px] lg:text-base font-medium">
        ...
        <div className="absolute mt-5 sm:mt-6 md:mt-8 lg:mt-0 top-4 sm:top-12 md:top-6 lg:top-12 -right-12 sm:-right-16 md:-right-16 bg-blue-500 rounded-lg px-2 sm:px-3 md:px-4 py-1 sm:py-2 flex items-center space-x-2 sm:space-x-3 max-w-xs sm:max-w-sm md:max-w-xs shadow-lg z-20 animate-bounce">
          ...
          <div className="text-white">
            <p className="font-bold text-[12px] lg:text-base text-sm">980k+</p>
